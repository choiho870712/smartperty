package com.example.smartperty.login
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun updateUiWithUser(model: LoggedInUserView) {
        ...
        var intent = Intent(this, TenantActivity().javaClass)
        if (displayName == "Landlord")
            intent = Intent(this, LandlordActivity().javaClass)
