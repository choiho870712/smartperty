...
import kotlinx.android.synthetic.main.card_estate_list.view.*

class EstateListAdapter(private val activity: Activity,
                        private val parentView: View,
                        private val myDataset: MutableList<Estate>)
    : RecyclerView.Adapter<EstateListAdapter.CardHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardHolder {
        val view = LayoutInflater.from(parent.context).inflate(
            R.layout.card_estate_list, parent, false)
